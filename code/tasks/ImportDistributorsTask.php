...
class ImportDistributorsTask extends ImportStockistsTask {
    ...
    protected function createDistributors(){
        flush(); ob_end_flush(); DB::alteration_message("================================================ CREATING distributors ================================================");ob_start();
        ...
        foreach($this->csv as $row) {
            ...
            if(!$distributor) {
                ...
                flush(); ob_end_flush(); DB::alteration_message(" --- Creating distributor: ".$row["NAME"], "created");ob_start();
            }
            else {
                flush(); ob_end_flush(); DB::alteration_message(" --- Updating distributor: ".$row["NAME"], "changed");ob_start();
            }
