...
<link type="text/css" rel="stylesheet" href="/mysite/thirdparty/jqte/jQuery-TE_v.1.4.0/jquery-te-1.4.0.css">
			...
			<ul class="secondUL" id="Example">
				...
				<li>
					<dl>
						...
						<dd class="readonly">
							<div>only editable by DT staff</div>
						</dd>
					</dl>
				</li>
			</ul>
...
<script type="text/javascript" src="/mysite/thirdparty/jqte/jQuery-TE_v.1.4.0/jquery-te-1.4.0.min.js" charset="utf-8"></script>
		...
		initEditing: function() {
			...
			jQuery(document).on(
				...
				function() {
					...
					jQuery.get(
						'CheckAllCountriesAndAllPrices/setobjectfield',
						data,
						function(result) {
